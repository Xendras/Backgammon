...
/**
 * Luokka jossa pelin sisältö piirretään. Sisältää myös paneelin joka vastaa
 * nappuloiden toiminnallisuudesta.
 *
...
public class PelilaudanPaneeli extends JPanel {
    ...
    /**
     * Luo paneelin joka koostuu piirrettävästä osuudesta (pelilauta sekä
     * pelinappulat) sekä JButton-gridistä joka ohjaa pelinappuloita.
     *
    ...
    public void piirraNappulat(Graphics graphics) {
        ...
        for (int i = 0; i < 6; i++) {
            ...
            if (nappuloidenMaara > 6) {
                if (peli.haePelilaudanNappulat().get(i + 13).get(0).haePelinappulanOmistaja() == peli.haePelaaja1()) {
                    graphics.setColor(Color.WHITE);
                    graphics.drawString("+"+String.valueOf(nappuloidenMaara-6), (i) * KolmionLeveys + 2* KolmionLeveys / 7, 6 * KolmionLeveys - KolmionLeveys / 3);
                } else {
                    graphics.setColor(Color.BLACK);
                    graphics.drawString("+"+String.valueOf(nappuloidenMaara-6), (i) * KolmionLeveys + 2* KolmionLeveys / 7, 6 * KolmionLeveys - KolmionLeveys / 3);
                }
        ...
        for (int i = 6; i < 12; i++) {
            ...
            if (nappuloidenMaara > 6) {
                if (peli.haePelilaudanNappulat().get(i + 13).get(0).haePelinappulanOmistaja() == peli.haePelaaja1()) {
                    graphics.setColor(Color.WHITE);
                    graphics.drawString("+"+String.valueOf(nappuloidenMaara-6), (i+1) * KolmionLeveys + 2* KolmionLeveys / 7, 6 * KolmionLeveys - KolmionLeveys / 3);
                } else {
                    graphics.setColor(Color.BLACK);
                    graphics.drawString("+"+String.valueOf(nappuloidenMaara-6), (i+1) * KolmionLeveys + 2* KolmionLeveys / 7, 6 * KolmionLeveys - KolmionLeveys / 3);
                }
        ...
        for (int i = 0; i < 6; i++) {
            ...
            if (nappuloidenMaara > 6) {
                if (peli.haePelilaudanNappulat().get(12 - i).get(0).haePelinappulanOmistaja() == peli.haePelaaja1()) {
                    graphics.setColor(Color.WHITE);
                    graphics.drawString("+"+String.valueOf(nappuloidenMaara-6), (i) * KolmionLeveys + 2* KolmionLeveys / 7, KentanKorkeus -  5* KolmionLeveys - KolmionLeveys/3);
                } else {
                    graphics.setColor(Color.BLACK);
                    graphics.drawString("+"+String.valueOf(nappuloidenMaara-6), (i) * KolmionLeveys + 2* KolmionLeveys / 7, KentanKorkeus - 5 * KolmionLeveys - KolmionLeveys/3);
                }
        ...
        for (int i = 6; i < 12; i++) {
            ...
            if (nappuloidenMaara > 6) {
                if (peli.haePelilaudanNappulat().get(12 - i).get(0).haePelinappulanOmistaja() == peli.haePelaaja1()) {
                    graphics.setColor(Color.WHITE);
                    graphics.drawString("+"+String.valueOf(nappuloidenMaara-6), (i+1) * KolmionLeveys + 2 * KolmionLeveys / 7, KentanKorkeus - 5 * KolmionLeveys - KolmionLeveys/3);
                } else {
                    graphics.setColor(Color.BLACK);
                    graphics.drawString("+"+String.valueOf(nappuloidenMaara-6), (i+1) * KolmionLeveys + 2 * KolmionLeveys / 7, KentanKorkeus - 5 * KolmionLeveys - KolmionLeveys/3);
                }
